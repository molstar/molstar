...
import { AnimationSvg, GetAppSvg, HelpOutlineSvg, MagicWandSvg, TourSvg, Icon, OpenInBrowserSvg, VisibilityOffOutlinedSvg, VisibilityOutlinedSvg } from '../../../mol-plugin-ui/controls/icons';
