...
loadCheckpoint(`mol-model-props/computed/secondary-structure/dssp/bends.ts::start`);
/**
...
loadCheckpoint(`mol-model-props/computed/secondary-structure/dssp/bends.ts::end`);
