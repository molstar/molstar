...
loadCheckpoint(`mol-model-props/computed/representations/interactions-intra-unit-cylinder.ts::start`);
/**
...
loadCheckpoint(`mol-model-props/computed/representations/interactions-intra-unit-cylinder.ts::end`);
