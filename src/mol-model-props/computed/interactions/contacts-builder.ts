...
loadCheckpoint(`mol-model-props/computed/interactions/contacts-builder.ts::start`);
/**
...
loadCheckpoint(`mol-model-props/computed/interactions/contacts-builder.ts::end`);
