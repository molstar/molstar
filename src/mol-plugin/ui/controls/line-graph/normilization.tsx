...
export function normalizeToFitGraph(height:number, width:number, point: Vec2, padding:number=0) {
    const min = padding/2;
...
export function scale(value: number, fromMin: number, fromMax: number, toMin: number, toMax: number) {
