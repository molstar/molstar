...
const Superpositions = {
  "1cdw": [
    -0.4665815186, 0.6063873444, -0.6438913535, 0, -0.581544075, -0.7588303199,
    -0.2932286385, 0, -0.6664144171, 0.2376361381, 0.7066971703, 0,
    135.0863694935, 105.5007997009, 153.6890178993, 1,
  ] as unknown as Mat4,
  "1vtl": [
    -0.4769460004, 0.7214347188, -0.5020502557, 0, -0.297882932, 0.4047204695,
    0.8645617968, 0, 0.8269149119, 0.5619014932, 0.0218732801, 0, 65.6043682658,
    -3.7328402905, -16.8650755387, 1,
  ] as unknown as Mat4,
  "7enc": [
    0.8975055044, -0.4316347566, -0.0904174009, 0, 0.247274877, 0.3227849997,
    0.9136000105, 0, -0.3651561375, -0.8423189899, 0.3964337454, 0,
    -189.7572972798, 304.0841220076, -411.5005782853, 1,
  ] as unknown as Mat4,
};
...
`,
    state: (): Root => {
      ...
      _1vok_comp.representation({ type: "cartoon" }).color({
        custom: {
...
`,
    state: () => {
      ...
      label(_1cdw, {
        selector: {
          label_asym_id: "C",
          beg_label_seq_id: 160,
          end_label_seq_id: 177,
        },
        text: "TBP (H. sapiens)",
      });
...
`,
    state: () => {
      ...
      label(_1cdw, {
        selector: { label_asym_id: "A", label_seq_id: 5 },
        text: "T",
      });
      label(_1cdw, {
        selector: { label_asym_id: "A", label_seq_id: 6 },
        text: "A",
      });
      label(_1cdw, {
        selector: { label_asym_id: "A", label_seq_id: 7 },
        text: "T",
      });
      label(_1cdw, {
        selector: { label_asym_id: "A", label_seq_id: 8 },
        text: "A",
      });
      label(_1cdw, {
        selector: { label_asym_id: "A", label_seq_id: 9 },
        text: "A",
      });
      label(_1cdw, {
...
`,
    state: () => {
      ...
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 38 },
        text: "Arg192",
      });
      ...
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 45 },
        text: "Arg199",
      });
      drawInteractions(_1cdw, [
        [
      ...
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 136 },
        text: "Arg290",
      });
      drawInteractions(_1cdw, [
        [
      ...
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 50 },
        text: "Arg204",
      });
      drawInteractions(_1cdw, [
        [
...
`,
    state: () => {
      ...
      // Asn: 9, 99, 155
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 9 },
        text: "Asn163",
      });
      label(_1cdw, {
        selector: { label_asym_id: "C", label_seq_id: 155 },
        text: "Thr309",
      });
      drawInteractions(_1cdw, [
        [
...
export function buildStory(): MVSData_States {
  ...
  return {
    ...
    metadata: {
      title:
        "The Structural Story of TATA-Binding Protein and its Role in Transcription Initiation",
      version: "1.0",
