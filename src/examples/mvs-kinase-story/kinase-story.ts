...
const PDBLinks = {
    '1opl': 'https://doi.org/10.2210/pdb1opl/pdb',
    '2gqg': 'https://doi.org/10.2210/pdb2gqg/pdb',
    '1iep': 'https://doi.org/10.2210/pdb1iep/pdb',
    '3ik3': 'https://doi.org/10.2210/pdb3ik3/pdb',
    '3oxz': 'https://doi.org/10.2210/pdb3oxz/pdb',
};
...
Normally, the ABL kinase ([PDB ID 1OPL](${PDBLinks['1opl']})) is a well-regulated enzyme, kept in check by its SH3 and SH2 domains which fold back onto the kinase domain like a safety lock.
`,
        state: () => {
            const builder = createMVSBuilder();
...
Comparing the normal protein to the kinase domain alone ([PDB ID 2GQG](${PDBLinks['2gqg']}), in light red), you can
...
and lock BCR-ABL in an inactive conformation. The Imatinib-bound structure ([PDB ID 1IEP](${PDBLinks['1iep']}))
...
What was once a threonine (Thr) is now an isoleucine (Ile), a single mutation [T315I](https://doi.org/10.1016/j.ccr.2011.03.003), shown on [PDB ID 3IK3](${PDBLinks['3ik3']}) in orange.
...
The battle didn't end there. Scientists knew they needed a new inhibitor—one that could work even against T315I. Enter Ponatinib (shown in [PDB ID 3OXZ](${PDBLinks['3oxz']})), a next-generation
