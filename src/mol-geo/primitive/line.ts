...
export type LineProps = Partial<typeof DefaultLineProps>

export function Line(props?: LineProps): Primitive {
    const { radialSegments, heightSegments, topCap, bottomCap, thetaStart, thetaLength } = { ...DefaultLineProps, ...props };
    const radiusTop = 1;
