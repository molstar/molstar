...
loadCheckpoint(`mol-repr/structure/visual/carbohydrate-terminal-link-cylinder.ts::start`);
/**
...
loadCheckpoint(`mol-repr/structure/visual/carbohydrate-terminal-link-cylinder.ts::end`);
