...
loadCheckpoint(`mol-repr/structure/visual/gaussian-surface-wireframe.ts::start`);
/**
...
loadCheckpoint(`mol-repr/structure/visual/gaussian-surface-wireframe.ts::end`);
