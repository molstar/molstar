...
const BallAndStick = {
  ...
  ignore_hydrogens: OptionalField(
    bool,
    false,
    'Controls whether hydrogen atoms are drawn.',
  ),
...
const VolumeIsoSurface = {
  ...
  absolute_isovalue: OptionalField(
    nullable(float),
    null,
    'Absolute isovalue. Overrides `relative_isovalue`.',
  ),
  /** Show mesh wireframe. Defaults to false. */
  show_wireframe: OptionalField(
    bool,
    false,
    'Show mesh wireframe. Defaults to false.',
  ),
...
const ClipParamsBase = {
  ...
  variant: OptionalField(
    literal('object', 'pixel'),
    'pixel',
    'Variant of the clip node, either "object" or "pixel"',
  ),
};

export const MVSClipParams = UnionParamsSchema('type', 'Clip type', {
