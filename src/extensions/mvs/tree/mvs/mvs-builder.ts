...
class _Base<TKind extends MVSKind> {
    ...
    protected addChild<TChildKind extends MVSKind>(kind: TChildKind, params_: ParamsOfKind<MVSTree, TChildKind> & CustomAndRef) {
        const { params, custom, ref } = splitParams<ParamsOfKind<MVSTree, TChildKind>>(params_);
...
export class Root extends _Base<'root'> {
    ...
    download(params: ParamsOfKind<MVSTree, 'download'> & CustomAndRef): Download {
...
export class Download extends _Base<'download'> {
    ...
    parse(params: ParamsOfKind<MVSTree, 'parse'> & CustomAndRef) {
...
export class Parse extends _Base<'parse'> {
    ...
    modelStructure(params: Pick<ParamsOfKind<MVSTree, 'structure'>, typeof StructureParamsSubsets['model'][number]> & CustomAndRef = {}): Structure {
     ...
     * Return builder pointing to the new node. */
    assemblyStructure(params: Pick<ParamsOfKind<MVSTree, 'structure'>, typeof StructureParamsSubsets['assembly'][number]> & CustomAndRef = {}): Structure {
        return new Structure(this._root, this.addChild('structure', {
            type: 'assembly',
     ...
     * Return builder pointing to the new node. */
    symmetryStructure(params: Pick<ParamsOfKind<MVSTree, 'structure'>, typeof StructureParamsSubsets['symmetry'][number]> & CustomAndRef = {}): Structure {
        return new Structure(this._root, this.addChild('structure', {
            type: 'symmetry',
     ...
     * Return builder pointing to the new node. */
    symmetryMatesStructure(params: Pick<ParamsOfKind<MVSTree, 'structure'>, typeof StructureParamsSubsets['symmetry_mates'][number]> & CustomAndRef = {}): Structure {
        return new Structure(this._root, this.addChild('structure', {
            type: 'symmetry_mates',
...
export class Structure extends _Base<'structure'> {
    ...
    component(params: Partial<ParamsOfKind<MVSTree, 'component'>> & CustomAndRef = {}): Component {
    ...
    componentFromUri(params: ParamsOfKind<MVSTree, 'component_from_uri'> & CustomAndRef): Component {
    ...
    componentFromSource(params: ParamsOfKind<MVSTree, 'component_from_source'> & CustomAndRef): Component {
    ...
    labelFromUri(params: ParamsOfKind<MVSTree, 'label_from_uri'> & CustomAndRef): Structure {
    ...
    labelFromSource(params: ParamsOfKind<MVSTree, 'label_from_source'> & CustomAndRef): Structure {
    ...
    tooltipFromUri(params: ParamsOfKind<MVSTree, 'tooltip_from_uri'> & CustomAndRef): Structure {
    ...
    tooltipFromSource(params: ParamsOfKind<MVSTree, 'tooltip_from_source' & CustomAndRef>): Structure {
    ...
    transform(params: ParamsOfKind<MVSTree, 'transform'> & CustomAndRef = {}): Structure {
...
export class Component extends _Base<'component' | 'component_from_uri' | 'component_from_source'> {
    ...
    representation(params: Partial<ParamsOfKind<MVSTree, 'representation'>> & CustomAndRef = {}): Representation {
    ...
    label(params: ParamsOfKind<MVSTree, 'label'> & CustomAndRef): Component {
    ...
    tooltip(params: ParamsOfKind<MVSTree, 'tooltip'> & CustomAndRef): Component {
    ...
    focus(params: ParamsOfKind<MVSTree, 'focus'> & CustomAndRef = {}): Component {
...
export class Representation extends _Base<'representation'> {
    ...
    color(params: ParamsOfKind<MVSTree, 'color'> & CustomAndRef): Representation {
    ...
    colorFromUri(params: ParamsOfKind<MVSTree, 'color_from_uri'> & CustomAndRef): Representation {
    ...
    colorFromSource(params: ParamsOfKind<MVSTree, 'color_from_source'> & CustomAndRef): Representation {
