...
export const MVSTreeSchema = TreeSchema({
    ...
    nodes: {
        ...
        primitives: {
            ...
            params: SimpleParamsSchema({
                color: OptionalField(ColorT, 'white', 'TODO parameter description'),
                label_color: OptionalField(ColorT, 'white', 'TODO parameter description'),
                tooltip: OptionalField(nullable(str), null, 'TODO parameter description'),
                opacity: OptionalField(float, 1, 'TODO parameter description'),
                label_opacity: OptionalField(float, 1, 'TODO parameter description'),
