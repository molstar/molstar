...
export const ColorLists = {
    ...
    'magma-no-black': ColorList('Magma (no black)', 'sequential', // used to be called 'magma'
        'Perceptually uniform shades of black-red-white, with black region removed',
    ...
    'inferno-no-black': ColorList('Inferno (no black)', 'sequential', // used to be called 'inferno'
        'Perceptually uniform shades of black-red-yellow, with black region removed',
    ...
    'turbo-no-black': ColorList('Turbo (no black)', 'sequential', // used to be called 'turbo'
        'Improved (smooth) rainbow colormap for visualization, with black region removed',
    ...
    'cubehelix-default': ColorList('CubehelixDefault', 'sequential',
        'CubehelixDefault color map from D3.js',
    ...
    'rainbow': ColorList('Rainbow', 'sequential',
        'Rainbow color map from D3.js, cyclic',
    ...
    'sinebow': ColorList('Sinebow', 'sequential',
        'Sinebow color map from D3.js, cyclic',
    ...
    'category-10': ColorList('Category10', 'qualitative',
        'Category10 color map from D3.js / tab10 from Matplotlib (default in Matplotlib)',
    ...
    'observable-10': ColorList('Observable10', 'qualitative',
        'Observable10 color map from D3.js',
    ...
    'tableau-10': ColorList('Tableau10', 'qualitative',
        'Tableau10 color map from D3.js',
