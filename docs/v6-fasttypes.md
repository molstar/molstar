...
| CDN Viewer and MVS Stories | Bundled JS/CSS/HTML/assets under the root `molstar` package's existing app paths | Compatible classic-script globals/APIs and custom elements; existing MVS HTML using `molstar@latest` keeps working |
